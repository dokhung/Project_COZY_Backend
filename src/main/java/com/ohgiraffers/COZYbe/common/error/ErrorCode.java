...
public enum ErrorCode {
    ...
    NO_SUCH_USER(HttpStatus.UNAUTHORIZED, "USER-002", "해당 유저는 존재하지 않습니다."),
    INVALID_PASSWORD(HttpStatus.UNAUTHORIZED, "USER-003", "비밀번호가 유효하지 않습니다."),
    INVALID_EMAIL(HttpStatus.UNAUTHORIZED, "USER-004", "이메일이 중복이거나 유효하지 않습니다."),
    FAILED_GET_ACCESS_TOKEN(HttpStatus.EXPECTATION_FAILED, "TOKEN-001", "Access Token 을 가져오는데 실패했습니다."),
    INVALID_TOKEN(HttpStatus.EXPECTATION_FAILED, "TOKEN-002", "Token 이 유효하지 않습니다."),
